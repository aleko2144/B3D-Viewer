...
[В ветке v2.0](https://github.com/aleko2144/B3D-Viewer/tree/v2.0) хранится другая версия проекта, написанная с нуля в 2025 году и совместимая только с играми на VWI, вышедшими до "Дальнобойщиков 2", при этом качества кода там намного лучше.
